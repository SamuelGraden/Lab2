	...
	private class Display extends JPanel {
		...
		private void drawRoom(Graphics g) {
			...
			for (int i = 0; i < roomlist.size(); i++) {
				...
				g.fillRect(roomlist.get(i).getPosX(), roomlist.get(i).getPosY(), roomlist.get(i).getDx(),
						roomlist.get(i).getDy());
				g.setColor(roomlist.get(i).getColor());
				g.fillRect(roomlist.get(i).getPosX() + 2, roomlist.get(i).getPosY() + 2, roomlist.get(i).getDx() - 4,
						roomlist.get(i).getDy() - 4);
				for (int j = 1; j <= 4; j++) {
					if (roomlist.get(i).isConnected(j)) {
						if (j == 1) {
							...
							int endX = roomlist.get(i).getConnected(j).getPosX()
									+ (roomlist.get(i).getConnected(j).getDx() / 2);
							int endY = roomlist.get(i).getConnected(j).getPosY()
									+ roomlist.get(i).getConnected(j).getDy();
							...
							g.fillOval(startX - 5, startY + 5, 5, 5);
						}
						if (j == 2) {
							int startX = roomlist.get(i).getPosX();
							int startY = roomlist.get(i).getPosY() + roomlist.get(i).getDy() / 2;
							int endX = roomlist.get(i).getConnected(j).getPosX()
									+ roomlist.get(i).getConnected(j).getDx();
							int endY = roomlist.get(i).getConnected(j).getPosY()
									+ roomlist.get(i).getConnected(j).getDy() / 2;
						...
						if (j == 3) {
							...
							g.setColor(Color.red);
							g.fillOval(startX - 5, startY - 10, 5, 5);
						}
						if (j == 4) {
							...
							g.setColor(Color.red);
							g.fillOval(startX - 10, startY - 5, 5, 5);
						}
					}
				}
			}
